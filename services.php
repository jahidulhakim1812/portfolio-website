<?php
// services.php - 3D Tech Background with Services Listing (Fixed Dark Mode & Perfect Styles)
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Navbar with glass effect (matching 3D theme) */
        .glass-nav {
            position: relative;
            top: 0;
            left: 0;
        ...
        /* Footer (included via include, but we provide fallback styles) */
        footer {
        ...
        @media (max-width: 768px) {
            .service-img, .service-icon-fallback { height: 150px; }
...
<!-- 3D Canvas Background (Neural Network Style) -->
...
<div class="main-content">
                                ...
                                <div class="service-card">
                                    ...
                                    <?php else: ?>
                                        <div class="service-icon-fallback">
                                            <i class="<?php echo htmlspecialchars($service['icon_class'] ?? 'fas fa-cube'); ?> fa-3x"></i>
                                        </div>
                                    <?php endif; ?>
    ...
    <!-- Footer (Full HTML - No external dependency) -->
...
<script>
    ...
    function initDarkMode() {
        ...
        // Check localStorage for 'lightMode' preference
